...
class JeansDetailsScreens extends StatefulWidget {
  final String imageUrl;
  final String title;
  final String description;
  final String price;

  const JeansDetailsScreens(
      {super.key,
        ...
        required this.price});
  @override
  State<JeansDetailsScreens> createState() => _JeansDetailsScreensState();
}

class _JeansDetailsScreensState extends State<JeansDetailsScreens> {
